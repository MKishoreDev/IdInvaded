...
from Invaded import inv, ubot, log, BOT_NAME, UBOT_NAME, LOG_GROUP_ID
...
async def main():
 ...
 await ubot.send_video("@Cityofcreations", "https://telegra.ph/file/a69feed5d48f6554ac47a.mp4", caption="**Invaded Started Successfully**\n\n`Invaders!!! Let's Defeat The Darkness`")
